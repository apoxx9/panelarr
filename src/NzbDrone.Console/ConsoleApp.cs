...
namespace NzbDrone.Console
{
    public static class ConsoleApp
    {
        ...
        public static void Main(string[] args)
        {
            ...
            catch (PanelarrStartupException ex)
            {
            ...
            catch (SocketException ex)
            {
                System.Console.WriteLine("");
                System.Console.WriteLine("");
                Logger.Fatal(ex.Message + ". This can happen if another instance of Panelarr is already running another application is using the same port (default: 8787) or the user has insufficient permissions");
