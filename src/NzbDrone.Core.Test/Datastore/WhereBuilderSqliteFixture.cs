...
namespace NzbDrone.Core.Test.Datastore
{
    ...
    public class WhereBuilderSqliteFixture : CoreTest
    {
        ...
        private WhereBuilderSqlite WhereMetadata(Expression<Func<SeriesMetadata, bool>> filter)
        {
            return new WhereBuilderSqlite(filter, true, 0);
        }
        ...
        public void where_column_contains_string()
        {
            ...
            _subject.ToString().Should().Be($"(\"Seriess\".\"CleanName\" LIKE '%' || @Clause1_P1 || '%')");
        ...
        public void where_string_contains_column()
        {
            ...
            _subject.ToString().Should().Be($"(@Clause1_P1 LIKE '%' || \"Seriess\".\"CleanName\" || '%')");
            _subject.Parameters.Get<string>("Clause1_P1").Should().Be(test);
        }
        ...
        public void where_in_list()
        {
            ...
            _subject.ToString().Should().Be($"(\"Seriess\".\"Id\" IN (1, 2, 3))");
        ...
        public void where_in_list_2()
        {
            ...
            _subject.ToString().Should().Be($"((\"Seriess\".\"CleanName\" = @Clause1_P1) AND (\"Seriess\".\"Id\" IN (1, 2, 3)))");
        }
        ...
        public void enum_in_list()
        {
            ...
            _subject.ToString().Should().Be($"(\"SeriesMetadata\".\"Status\" IN @Clause1_P1)");
        }
