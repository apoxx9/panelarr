...
namespace NzbDrone.Core.Test.DecisionEngineTests
{
    ...
    public class CustomFormatAllowedByProfileSpecificationFixture : CoreTest<CustomFormatAllowedbyProfileSpecification>
    {
        ...
        public void should_allow_if_format_score_greater_than_min()
        {
            ...
            _remoteAlbum.Series.QualityProfile.Value.FormatItems = CustomFormatsTestHelpers.GetSampleFormatItems(_format1.Name);
            _remoteAlbum.CustomFormatScore = _remoteAlbum.Series.QualityProfile.Value.CalculateCustomFormatScore(_remoteAlbum.CustomFormats);
        ...
        public void should_deny_if_format_score_not_greater_than_min()
        {
            ...
            Console.WriteLine(_remoteAlbum.Series.QualityProfile.Value.MinFormatScore);
        ...
        {
            _remoteAlbum.CustomFormats = new List<CustomFormat> { _format2, _format1 };
            _remoteAlbum.Series.QualityProfile.Value.FormatItems = CustomFormatsTestHelpers.GetSampleFormatItems(_format1.Name, _format2.Name);
            _remoteAlbum.CustomFormatScore = _remoteAlbum.Series.QualityProfile.Value.CalculateCustomFormatScore(_remoteAlbum.CustomFormats);
        ...
        public void should_allow_if_no_format_was_parsed_min_score_is_zero()
        {
            _remoteAlbum.CustomFormats = new List<CustomFormat> { };
            _remoteAlbum.Series.QualityProfile.Value.FormatItems = CustomFormatsTestHelpers.GetSampleFormatItems(_format1.Name, _format2.Name);
            _remoteAlbum.Series.QualityProfile.Value.MinFormatScore = 0;
            _remoteAlbum.CustomFormatScore = _remoteAlbum.Series.QualityProfile.Value.CalculateCustomFormatScore(_remoteAlbum.CustomFormats);
