...
namespace NzbDrone.Core.Test.ProviderTests.RecycleBinProviderTests
{
    ...
    public class DeleteDirectoryFixture : CoreTest
    {
        ...
        public void should_use_delete_when_recycleBin_is_not_configured()
        {
            ...
            var path = @"C:\Test\Comics\Saga (2012)".AsOsAgnostic();
        ...
        public void should_use_move_when_recycleBin_is_configured()
        {
            ...
            Mocker.GetMock<IDiskTransferService>()
                  .Verify(v => v.TransferFolder(path, @"C:\Test\Recycle Bin\Saga (2012)".AsOsAgnostic(), TransferMode.Move), Times.Once());
        }
        ...
        public void should_call_directorySetLastWriteTime()
        {
            ...
            Mocker.GetMock<IDiskProvider>().Verify(v => v.FolderSetLastWriteTime(@"C:\Test\Recycle Bin\Saga (2012)".AsOsAgnostic(), It.IsAny<DateTime>()), Times.Once());
        }
        ...
        public void should_call_fileSetLastWriteTime_for_each_file()
        {
            ...
            Mocker.GetMock<IDiskProvider>().Setup(s => s.GetFiles(@"C:\Test\Recycle Bin\Saga (2012)".AsOsAgnostic(), true))
