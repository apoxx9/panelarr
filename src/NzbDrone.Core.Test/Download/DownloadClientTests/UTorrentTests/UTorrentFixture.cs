...
namespace NzbDrone.Core.Test.Download.DownloadClientTests.UTorrentTests
{
    ...
    public class UTorrentFixture : DownloadClientFixtureBase<UTorrent>
    {
        ...
        {
            var httpHeader = new HttpHeader();
            httpHeader["Location"] = "http://test.panelarr.com/not-a-real-torrent.torrent";
        ...
        public void should_return_status_with_outputdirs()
        {
            ...
            result.OutputRootFolders.First().Should().Be(@"C:\Downloads\Finished\utorrent\panelarr".AsOsAgnostic());
        }
