    ...
    public class VuzeFixture : TransmissionFixtureBase<Vuze>
    {
        ...
        public async Task Download_with_TvDirectory_should_force_directory()
        {
            ...
            Mocker.GetMock<ITransmissionProxy>()
                .Verify(v => v.AddTorrentFromData(It.IsAny<byte[]>(), @"C:/Downloads/Finished/Panelarr", It.IsAny<TransmissionSettings>()), Times.Once());
        }
        ...
        public async Task Download_with_category_should_force_directory()
        {
            ...
            Mocker.GetMock<ITransmissionProxy>()
                  .Verify(v => v.AddTorrentFromData(It.IsAny<byte[]>(), @"C:/Downloads/Finished/transmission/Panelarr", It.IsAny<TransmissionSettings>()), Times.Once());
        }
