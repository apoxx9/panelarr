...
namespace NzbDrone.Core.Test.ParserTests
{
    ...
    public class CrapParserFixture : CoreTest
    {
        ...
        [TestCase("Vh1FvU3bJXw6zs8EEUX4bMo5vbbMdHghxHirc.cbz")]
        [TestCase("0e895c37245186812cb08aab1529cf8ee389dd05.cbz")]
        [TestCase("08bbc153931ce3ca5fcafe1b92d3297285feb061.cbz")]
        [TestCase("185d86a343e39f3341e35c4dad3ff159")]
        [TestCase("ah63jka93jf0jh26ahjas961.cbz")]
        ...
        {
            Parser.Parser.ParseIssueTitle(title).Should().BeNull();
        ...
        public void should_not_parse_md5()
        {
            ...
            for (var i = 0; i < repetitions; i++)
            {
                ...
                if (Parser.Parser.ParseIssueTitle(hash) == null)
                {
                    success++;
                }
            }
        ...
        public void should_not_parse_random(int length)
        {
            ...
            for (var i = 0; i < repetitions; i++)
            {
                ...
                if (Parser.Parser.ParseIssueTitle(hash.ToString()) == null)
                {
                    success++;
                }
            }
        ...
        {
            Parser.Parser.ParseIssueTitle(fileName).Should().BeNull();
        }
    }
}
