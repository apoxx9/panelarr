        ...
        where TProviderDefinition : ProviderDefinition, new()
    {
        public virtual TProviderResource ToResource(TProviderDefinition definition)
        {
            return new TProviderResource
            {
                ...
                //panelarr/supported is an disambagation page. the # should be a header on the page with appropiate details/link
                InfoLink = string.Format("https://wiki.servarr.com/panelarr/supported#{0}",
