...
namespace NzbDrone.Common.EnvironmentInfo
{
    ...
    public class AppFolderFactory : IAppFolderFactory
    {
        ...
        public void Register()
        {
            ...
            {
                throw new PanelarrStartupException("Cannot create AppFolder, Access to the path {0} is denied", _appFolderInfo.AppDataFolder);
            }
            ...
            {
                throw new PanelarrStartupException("AppFolder {0} is not writable", _appFolderInfo.AppDataFolder);
            }
