    ...
    public class RuntimeInfo : IRuntimeInfo
    {
        ...
        public RuntimeInfo(Logger logger, IHostLifetime hostLifetime = null)
        {
            ...
            if (entry != null)
            {
                ...
                IsWindowsTray = OsInfo.IsWindows && entry.ModuleName == $"{ProcessProvider.PANELARR_PROCESS_NAME}.exe";
            }
        }
        ...
        public bool IsTray
        {
            get
            {
                if (OsInfo.IsWindows)
                {
                    return IsUserInteractive && Process.GetCurrentProcess().ProcessName.Equals(ProcessProvider.PANELARR_PROCESS_NAME, StringComparison.InvariantCultureIgnoreCase);
                }
