...
namespace NzbDrone.Common.Extensions
{
    public static class PathExtensions
    {
        ...
        private const string DB = "panelarr.db";
        private const string DB_RESTORE = "panelarr.restore";
        private const string LOG_DB = "logs.db";
        private const string CACHE_DB = "cache.db";
        private const string NLOG_CONFIG_FILE = "nlog.config";
        private const string UPDATE_CLIENT_EXE_NAME = "Panelarr.Update";

        private static readonly string UPDATE_SANDBOX_FOLDER_NAME = "panelarr_update" + Path.DirectorySeparatorChar;
        private static readonly string UPDATE_PACKAGE_FOLDER_NAME = "Panelarr" + Path.DirectorySeparatorChar;
        private static readonly string UPDATE_BACKUP_FOLDER_NAME = "panelarr_backup" + Path.DirectorySeparatorChar;
        private static readonly string UPDATE_BACKUP_APPDATA_FOLDER_NAME = "panelarr_appdata_backup" + Path.DirectorySeparatorChar;
        private static readonly string UPDATE_CLIENT_FOLDER_NAME = "Panelarr.Update" + Path.DirectorySeparatorChar;
