...
namespace NzbDrone.Common
{
    ...
    public class ConsoleService : IConsoleService
    {
        ...
        public void PrintHelp()
        {
            ...
            Console.WriteLine("                 /{0} Don't open Panelarr in a browser", StartupContext.NO_BROWSER);
            Console.WriteLine("                 /{0} Start Panelarr terminating any other instances", StartupContext.TERMINATE);
