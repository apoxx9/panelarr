...
namespace NzbDrone.Common.Instrumentation
{
    public static class NzbDroneLogger
    {
        ...
        {
            RegisterAppFile(appFolderInfo, "appFileInfo", "panelarr.txt", 5, LogLevel.Info);
            RegisterAppFile(appFolderInfo, "appFileDebug", "panelarr.debug.txt", 50, LogLevel.Off);
            RegisterAppFile(appFolderInfo, "appFileTrace", "panelarr.trace.txt", 50, LogLevel.Off);
        }
