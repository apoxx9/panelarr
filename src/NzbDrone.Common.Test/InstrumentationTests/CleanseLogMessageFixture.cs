...
namespace NzbDrone.Common.Test.InstrumentationTests
{
    ...
    public class CleanseLogMessageFixture
    {
        ...
        [TestCase(@"https://rss.omgwtfnzbs.org/rss-search.php?catid=19,20&user=Panelarr&api=mySecret&eng=1")]
        ...
        [TestCase("Hardlinking comic file: /home/mySecret/Downloads to /media/abc.cbz")]
        [TestCase("Hardlinking comic file: /Users/mySecret/Downloads to /media/abc.cbz")]
        [TestCase("Hardlink '/home/mySecret/Downloads/abs.cbz' to '/media/abc.cbz' failed.")]
        [TestCase("Hardlink '/Users/mySecret/Downloads/abs.cbz' to '/media/abc.cbz' failed.")]
        [TestCase("https://notifiarr.com/notifier.php: api=1234530f-422f-4aac-b6b3-01233210aaaa&radarr_health_issue_message=Download")]
        [TestCase("/panelarr/signalr/messages/negotiate?access_token=1234530f422f4aacb6b301233210aaaa&negotiateVersion=1")]
        [TestCase(@"[Info] MigrationController: *** Migrating Database=panelarr-main;Host=postgres14;Username=mySecret;Password=mySecret;Port=5432;Enlist=False ***")]
        [TestCase(@"[Info] MigrationController: *** Migrating Database=panelarr-main;Host=postgres14;Username=mySecret;Password=mySecret;Port=5432;token=mySecret;Enlist=False&username=mySecret;mypassword=mySecret;mypass=shouldkeep1;test_token=mySecret;password=123%@%_@!#^#@;use_password=mySecret;get_token=shouldkeep2;usetoken=shouldkeep3;passwrd=mySecret;")]
        ...
        // Notifiarr
        [TestCase(@"https://xxx.yyy/api/v1/notification/panelarr/9pr04sg6-0123-3210-imav-eql2tyu8xyui")]
