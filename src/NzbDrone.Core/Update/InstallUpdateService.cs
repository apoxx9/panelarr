...
namespace NzbDrone.Core.Update
{
    public class InstallUpdateService : IExecute<ApplicationUpdateCommand>, IExecute<ApplicationUpdateCheckCommand>, IHandle<ApplicationStartingEvent>
    {
        ...
        private bool InstallUpdate(UpdatePackage updatePackage)
        {
            ...
            {
                _logger.Warn("Temporary location '{0}' has less than 1 GB free space, Panelarr may not be able to update itself.", tempFolder);
            }
            ...
            _logger.ProgressInfo("Panelarr will restart shortly.");
        ...
        private void InstallUpdateWithScript(string updateSandboxFolder)
        {
            ...
            _logger.Info("Removing Panelarr.Update");
        ...
        private void EnsureAppDataSafety()
        {
            ...
            {
                throw new UpdateFailedException("Your Panelarr configuration '{0}' is being stored in application folder '{1}' which will cause data lost during the upgrade. Please remove any symlinks or redirects before trying again.", _appFolderInfo.AppDataFolder, _appFolderInfo.StartUpFolder);
            }
        }
        ...
        public void Execute(ApplicationUpdateCommand message)
        {
            ...
            if (latestAvailable != null)
            {
                try
                {
                    ...
                    _logger.ProgressDebug("Restarting Panelarr to apply updates");
                }
