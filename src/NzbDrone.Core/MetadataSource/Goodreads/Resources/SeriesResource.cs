...
{
    /// <summary>
    /// This class models an Series as defined by the Goodreads API.
    /// </summary>
    ...
    public sealed class SeriesResource : GoodreadsResource
    {
        ...
        /// </summary>
        public bool IsGoodreadsSeries { get; private set; }

        /// <summary>
        /// If <see cref="IsGoodreadsSeries"/> is true, this property is set to the author's Goodreads user Id.
        /// </summary>
        public int? GoodreadsUserId { get; private set; }

        /// <summary>
        /// The list of works associated with this series.
        /// </summary>
        ...
        public override void Parse(XElement element)
        {
            ...
            IsGoodreadsSeries = element.ElementAsBool("goodreads_author");
            if (IsGoodreadsSeries)
            {
