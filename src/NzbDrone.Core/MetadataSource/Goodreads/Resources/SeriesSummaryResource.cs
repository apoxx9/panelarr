...
namespace NzbDrone.Core.MetadataSource.Goodreads
{
    ...
    /// very brief information about an Series instead of their entire profile.
    /// </summary>
    [DebuggerDisplay("{DebuggerDisplay,nq}")]
    public sealed class SeriesSummaryResource : GoodreadsResource
    {
        ...
        /// <summary>
        /// The average rating for all of this author's issues.
        /// </summary>
        public decimal? AverageRating { get; private set; }

        /// <summary>
        /// The total count of all ratings of this author's issues.
        /// </summary>
        public int? RatingsCount { get; private set; }

        /// <summary>
        /// The total count of all the text reviews of this author's issues.
        /// </summary>
