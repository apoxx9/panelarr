...
namespace NzbDrone.Core.MetadataSource
{
    ...
    public class MetadataRequestBuilder : IMetadataRequestBuilder
    {
        ...
        private readonly IPanelarrCloudRequestBuilder _defaultRequestFactory;

        public MetadataRequestBuilder(IConfigService configService, IPanelarrCloudRequestBuilder defaultRequestBuilder)
        {
