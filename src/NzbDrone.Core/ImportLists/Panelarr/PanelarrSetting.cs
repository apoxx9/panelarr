...
{
    public class PanelarrSettingsValidator : AbstractValidator<PanelarrSettings>
    {
        public PanelarrSettingsValidator()
        {
    ...
    public class PanelarrSettings : IImportListSettings
    {
        private static readonly PanelarrSettingsValidator Validator = new PanelarrSettingsValidator();

        public PanelarrSettings()
        {
            BaseUrl = "";
            ApiKey = "";
        ...
        [FieldDefinition(0, Label = "Full URL", HelpText = "URL, including port, of the Panelarr instance to import from")]
        public string BaseUrl { get; set; }

        [FieldDefinition(1, Label = "API Key", Privacy = PrivacyLevel.ApiKey, HelpText = "Apikey of the Panelarr instance to import from")]
