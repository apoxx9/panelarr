...
namespace NzbDrone.Core.Download.Clients.Blackhole
{
    ...
    public class TorrentBlackholeSettings : IProviderConfig
    {
        ...
        [FieldDefinition(0, Label = "Torrent Folder", Type = FieldType.Path, HelpText = "Folder in which Panelarr will store the .torrent file")]
        public string TorrentFolder { get; set; }

        [FieldDefinition(1, Label = "Watch Folder", Type = FieldType.Path, HelpText = "Folder from which Panelarr should import completed downloads")]
        ...
        [DefaultValue(false)]
        [JsonProperty(DefaultValueHandling = DefaultValueHandling.Populate)]
        [FieldDefinition(4, Label = "Read Only", Type = FieldType.Checkbox, HelpText = "Instead of moving files this will instruct Panelarr to Copy or Hardlink (depending on settings/system configuration)")]
