            ...
            catch (WebException ex)
            {
                ...
                switch (ex.Status)
                {
                    ...
                    case WebExceptionStatus.ConnectionClosed:
                        ...
                        {
                            DetailedDescription = "Please verify your SSL configuration on both Deluge and Panelarr."
                        };
                    case WebExceptionStatus.SecureChannelFailure:
                        return new NzbDroneValidationFailure("UseSsl", "Unable to connect through SSL")
                        {
                            DetailedDescription = "Panelarr is unable to connect to Deluge using SSL. This problem could be computer related. Please try to configure both drone and Deluge to not use SSL."
                        };
                    default:
