...
namespace NzbDrone.Core.Indexers
{
    ...
    public class SeedCriteriaSettings
    {
        ...
        [FieldDefinition(2, Type = FieldType.Textbox, Label = "Collection Seed Time", Unit = "minutes", HelpText = "The time a torrent should be seeded before stopping, empty is download client's default", Advanced = true)]
