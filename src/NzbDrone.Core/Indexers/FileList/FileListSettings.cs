...
namespace NzbDrone.Core.Indexers.FileList
{
    ...
    public class FileListSettings : ITorrentIndexerSettings
    {
        ...
        [FieldDefinition(5, Type = FieldType.Number, Label = "Early Download Limit", Unit = "days", HelpText = "Time before release date Panelarr will download from this indexer, empty is no limit", Advanced = true)]
