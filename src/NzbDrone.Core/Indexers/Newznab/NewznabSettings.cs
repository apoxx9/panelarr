...
namespace NzbDrone.Core.Indexers.Newznab
{
    ...
    public class NewznabSettings : IIndexerSettings
    {
        ...
        [FieldDefinition(4, Type = FieldType.Number, Label = "Early Download Limit", HelpText = "Time before release date Panelarr will download from this indexer, empty is no limit", Unit = "days", Advanced = true)]
