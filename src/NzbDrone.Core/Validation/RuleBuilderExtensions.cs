...
namespace NzbDrone.Core.Validation
{
    public static class RuleBuilderExtensions
    {
        ...
        public static IRuleBuilderOptions<T, string> ValidUrlBase<T>(this IRuleBuilder<T, string> ruleBuilder, string example = "/panelarr")
        {
        ...
        public static IRuleBuilderOptions<T, string> ContainsPanelarr<T>(this IRuleBuilder<T, string> ruleBuilder)
        {
            ruleBuilder.SetValidator(new NotEmptyValidator(null));
            return ruleBuilder.SetValidator(new RegularExpressionValidator("panelarr", RegexOptions.IgnoreCase)).WithMessage("Must contain panelarr");
        }
    }
}
