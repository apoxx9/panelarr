...
namespace NzbDrone.Core.Books.Calibre
{
    ...
    public class CalibreProxy : ICalibreProxy
    {
        ...
        private ValidationFailure TestCalibre(CalibreSettings settings)
        {
            ...
            {
                return new ValidationFailure("Username", "Panelarr needs write access. Configure a user or trusted IP in calibre. See https://manual.calibre-ebook.com/server.html");
            }
