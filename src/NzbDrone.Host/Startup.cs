...
using Panelarr.Api.V1.System;
using Panelarr.Http;
using Panelarr.Http.Authentication;
using Panelarr.Http.ClientSchema;
using Panelarr.Http.ErrorManagement;
using Panelarr.Http.Frontend;
using Panelarr.Http.Middleware;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            services.AddLogging(b =>
            {
                ...
                b.AddFilter("Panelarr.Http.Authentication", LogLevel.Information);
...
#pragma warning restore ASPDEPR005
            ...
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1", new OpenApiInfo
                {
                    Version = "1.0.0",
                    Title = "Panelarr",
                    Description = "Panelarr API docs",
                    License = new OpenApiLicense
                    {
                        Name = "GPL-3.0",
                        Url = new Uri("https://github.com/Panelarr/Panelarr/blob/develop/LICENSE.md")
                    }
                });
        ...
        public void Configure(IApplicationBuilder app,
                              ...
                              PanelarrErrorPipeline errorHandler)
        {
