...
namespace NzbDrone.Update.UpdateEngine
{
    ...
    public class StartNzbDrone : IStartNzbDrone
    {
        ...
        {
            _logger.Info("Starting Panelarr");
            if (appType == AppType.Service)
            {
                ...
                {
                    _logger.Warn(e, "Couldn't start Panelarr Service (Most likely due to permission issues). Falling back to console.");
