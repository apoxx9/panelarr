...
import styles from './IssueshelfFooter.css';

const NO_CHANGE = 'noChange';

class IssueshelfFooter extends Component {
  ...
  render() {
    ...
    return (
      <PageContentFooter>
        ...
        <div className={styles.inputContainer}>
          <div className={styles.label}>
            {translate('MonitorExistingIssues')}
          </div>
        ...
        <div>
          <div className={styles.label}>
            {translate('CountSeriesSelected', { selectedCount })}
          </div>
...
export default IssueshelfFooter;
