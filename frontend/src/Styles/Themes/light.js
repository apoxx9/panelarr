...
module.exports = {
  ...
  // Header
  pageHeaderBackgroundColor: panelarrPurple,
  ...
  // Toolbar
  toolbarColor: '#e1e2e3',
  toolbarBackgroundColor: '#6A3D89',
  toolbarMenuItemBackgroundColor: '#5A2D79',
  ...
  toobarButtonHoverColor: '#fff',
  toobarButtonSelectedColor: '#fff',
