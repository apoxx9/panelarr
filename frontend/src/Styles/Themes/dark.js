...
module.exports = {
  ...
  menuItemHoverColor: panelarrRed,
  menuItemHoverBackgroundColor: '#606060',

  //
  // Toolbar

  toobarButtonHoverColor: panelarrRed,
  toobarButtonSelectedColor: panelarrRed,
