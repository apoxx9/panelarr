    ...
    return (
      <PageContent title={translate('GeneralSettings')}>
        ...
        <ConfirmModal
          ...
          kind={kinds.DANGER}
          title={translate('RestartPanelarr')}
          message={
            `Panelarr requires a restart to apply changes, do you want to restart now? ${isWindowsService ? 'Depending which user is running the Panelarr service you may need to restart Panelarr as admin once before the service will start automatically.' : ''}`
          }
