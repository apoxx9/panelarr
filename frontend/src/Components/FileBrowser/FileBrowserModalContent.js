        ...
        >
          {
            isWindowsService &&
              <Alert
                ...
                kind={kinds.WARNING}
              >
                Mapped network drives are not available when running as a Windows Service, see the <Link className={styles.faqLink} to="https://wiki.servarr.com/panelarr/faq">FAQ</Link> for more information.
              </Alert>
          }
