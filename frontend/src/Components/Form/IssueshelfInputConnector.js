...
import IssueshelfInput from './IssueshelfInput';

function createMapStateToProps() {
  return createSelector(
    (state) => state.providerOptions.issueshelves || defaultState,
...
class IssueshelfInputConnector extends Component {
  ...
  componentWillUnmount = () => {
    this.props.dispatchClearOptions({ section: 'issueshelves' });
  };
  ...
  _populate() {
    ...
    dispatchFetchOptions({
      section: 'issueshelves',
      action: 'getIssueshelves',
      queryParams: { name },
      provider,
      providerData
    });
...
IssueshelfInputConnector.propTypes = {
...
export default connect(createMapStateToProps, mapDispatchToProps)(IssueshelfInputConnector);
