...
function getUrls(state) {
  ...
  let icalUrl = `${window.location.host}${window.Panelarr.urlBase}/feed/v1/calendar/Panelarr.ics?`;
  ...
  icalUrl += `pastDays=${pastDays}&futureDays=${futureDays}&apikey=${encodeURIComponent(window.Panelarr.apiKey)}`;
