  ...
  return createSelector(
    ...
    (seriesIndex) => {
      ...
      switch (view) {
        ...
        case 'banners':
          return seriesIndex.bannerOptions.showSearchAction;
        case 'overview':
...
function createMapStateToProps() {
  return createSelector(
    ...
    (
      ...
      // If an series is deleted this selector may fire before the parent
      // selectors, which will result in an undefined series, if that happens
      // we want to return early here and again in the render function to avoid
      // trying to show an series that has no information available.
      ...
      const latestIssue = _.maxBy(series.issues, (issue) => issue.releaseDate);
