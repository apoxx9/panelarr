...
export const FETCH_SERIES_COLLECTION = 'series/fetchSeriesCollection';
...
export const fetchSeriesCollection = createThunk(FETCH_SERIES_COLLECTION);
...
export const actionHandlers = handleThunks({
  [FETCH_SERIES_COLLECTION]: createFetchHandler(section, '/series')
});
