...
FILES=( "Panelarr.Api.Test.dll" "Panelarr.Automation.Test.dll" "Panelarr.Common.Test.dll" "Panelarr.Core.Test.dll" "Panelarr.Host.Test.dll" "Panelarr.Integration.Test.dll" "Panelarr.Libraries.Test.dll" "Panelarr.Mono.Test.dll" "Panelarr.Update.Test.dll" "Panelarr.Windows.Test.dll" )
ASSMEBLIES=""
...
export PANELARR_TESTS_LOG_OUTPUT="File"
